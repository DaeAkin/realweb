...
<head>
    ...
    -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/DaumOpenEditor/DaumEditor-master/daumeditor/css/editor.css }" type="text/css" charset="utf-8"/>
    <script src="${pageContext.request.contextPath}/resources/DaumOpenEditor/DaumEditor-master/daumeditor/js/editor_loader.js" type="text/javascript" charset="utf-8"></script>
...
<script type="text/javascript">
	var config = {
		...
		form: 'freeboardwrite'+"", /* 등록하기 위한 Form 이름 */
		txIconPath: "${pageContext.request.contextPath}/resources/DaumOpenEditor/DaumEditor-master/daumeditor/images/icon/editor/", /*에디터에 사용되는 이미지 디렉터리, 필요에 따라 수정한다. */
		txDecoPath: "${pageContext.request.contextPath}/resources/DaumOpenEditor/DaumEditor-master/daumeditor/images/deco/contents/", /*본문에 사용되는 이미지 디렉터리, 서비스에서 사용할 때는 완성된 컨텐츠로 배포되기 위해 절대경로로 수정한다. */
		canvas: {
            exitEditor:{
                /*
